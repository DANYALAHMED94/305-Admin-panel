...
const CreateVideo = () => {
  ...
  const categories = ["Movies", "Music", "Sports", "TV Shows", "Gaming"];
  ...
  const subcategories = {
    ...
    TVShows: ["Reality", "Drama", "Comedy", "Documentary", "Thriller"],
    Gaming: ["Action", "Adventure", "RPG", "Simulation", "Strategy"],
  };
  ...
  const validateFields = () => {
    ...
    if (data?.subcategory === "") {
      validationArray.push("Subcategory");
    }
      ...
      <Portal>
        <div className="relative w-full">
          <div className="h-max w-[95%] mx-auto bg-gray-100 rounded-md p-3">
            <h2 className="py-2 text-xl font-bold">Create New Video</h2>
            <form
              action="submit"
              id="content-info"
              className="w-full bg-white rounded-md p-4 shadow-md"
            >
              <h2 className="font-bold text-lg p-1">Video Info</h2>
              ...
              <div className="flex gap-5 w-full">
                <div className="p-2 w-full">
                  <label htmlFor="subcategory" className="text-xs font-bold">
                  ...
                  >
                    ...
                    {data.category &&
                      subcategories[data.category].map((subcategory, index) => (
