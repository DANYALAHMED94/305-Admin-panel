...
//           <Link to="/admin/manage-category/create-category">
...
//         <h3 className="text-xl m-3 font-semibold">ALL Categories</h3>
//         {loading ? (
//           <div className="mt-3">
//             <LoadingBall />
//           </div>
  ...
  return (
    <Portal>
      <div className="flex flex-col min-h-screen bg-gray-100 p-2 md:p-6">
        ...
        <h3 className="text-xl mx-2 mb-4 font-semibold">All Categories</h3>
